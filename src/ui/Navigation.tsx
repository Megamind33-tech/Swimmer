        ...
        {navItems.map((item) => {
          ...
          return (
            <button key={item.id} onClick={() => setActiveTab(item.id)}
              ...
              <item.icon size={18} aria-hidden="true" className={isActive ? 'drop-shadow-[0_0_8px_rgba(24,200,240,0.4)]' : ''} />
            </button>
          );
        })}
      </nav>
        ...
        {navItems.map((item) => {
          ...
          return (
            <button key={item.id} onClick={() => setActiveTab(item.id)}
              ...
              <item.icon size={18} aria-hidden="true" className={isActive ? 'mb-0.5' : 'mb-0.5'} />
