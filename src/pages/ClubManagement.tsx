...
export function ClubManagement() {
      ...
      <div style={{ borderRadius: '14px', border: `1px solid ${PANEL_BORDER}`, background: PANEL, backdropFilter: 'blur(12px)', padding: '12px 14px', flexShrink: 0 }}>
        ...
        <div style={{ display: 'flex', gap: '8px', overflowX: 'auto', paddingBottom: '6px' }}>
          ...
          {signedAthletes.map((athlete, i) => (
            ...
            >
              <div style={{ position: 'absolute', top: -4, right: -4, background: '#C41E3A', color: '#fff', fontSize: '6px', fontWeight: 900, padding: '2px 5px', borderRadius: '100px', zIndex: 10, letterSpacing: '0.08em', fontFamily: "'Rajdhani', sans-serif" }}>
                NEW
              </div>
  ...
  return (
    ...
    >
      {/* Original two-column layout — shown on non-landscape screens */}
      <motion.div
