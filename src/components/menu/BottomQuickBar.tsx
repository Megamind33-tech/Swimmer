...
export const BottomQuickBar: React.FC<BottomQuickBarProps> = (props) => {
  ...
  return (
    <nav className="h-20 min-h-20 shrink-0 bg-gradient-to-t from-[#070f1f]/98 to-[#0a162b]/98 backdrop-blur-md border-t-2 border-white/20 px-4 flex items-center justify-center gap-2 sticky bottom-0 z-[70] shadow-[0_-10px_24px_rgba(0,0,0,0.45)] skew-x-[-6deg]">
      {quickActions.map((action) => (
        <button
          ...
          className="group flex flex-col items-center gap-1 px-4 py-2 hover:bg-white/10 transition-colors rounded-lg flex-1 skew-x-[6deg] border border-transparent hover:border-white/15"
        >
