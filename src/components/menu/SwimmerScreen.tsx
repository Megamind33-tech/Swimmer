...
export const SwimmerScreen: React.FC<SwimmerScreenProps> = ({
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-2 gap-6">
              {[
                ...
                <div key={idx} className="group/attr relative p-5 rounded-2xl border border-white/5 bg-white/5 hover:bg-white/10 hover:border-primary/40 transition-all duration-300">
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-2 gap-6">
              {[
                ...
                <div
                  key={idx}
                  className={`group/skill relative p-5 rounded-2xl border transition-all duration-300 overflow-hidden ${
                    skill.unlocked
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-2 gap-6">
              {[
                ...
                <div key={idx} className="group/gear relative p-5 rounded-2xl border border-white/5 bg-white/5 hover:border-primary/40 transition-all duration-300 overflow-hidden">
      ...
      case 'APPEARANCE':
        return (
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="relative group/viewer rounded-2xl overflow-hidden border border-white/5 bg-gradient-to-br from-white/10 to-transparent p-1">
                <div className="absolute inset-0 bg-primary/5 opacity-0 group-hover/viewer:opacity-100 transition-opacity duration-700" />
                <div className="h-[260px] rounded-2xl bg-surface flex items-center justify-center relative z-10 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 p-1.5 rounded-xl bg-surface/60 backdrop-blur-xl border border-white/10 scale-90 group-hover/viewer:scale-100 transition-all">
              ...
              <div className="grid gap-3 content-start">
                {[
                  ...
                  <button
                    key={idx}
                    className="w-full relative group/opt p-3 rounded-xl bg-white/5 border border-white/5 hover:border-primary/40 hover:bg-white/10 transition-all text-left flex items-center justify-between"
                  >
                    <div className="flex items-center gap-5">
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid gap-3">
              {[
                ...
                <div key={idx} className="group/rec relative p-5 rounded-2xl border border-white/5 bg-white/5 hover:border-primary/40 transition-all duration-300 flex items-center gap-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { label: 'Nationality', value: 'United States', icon: 'public' },
                  ...
                  { label: 'Physical Class', value: 'Tier 1 Athlete', icon: 'fitness_center' },
                ].map((bio, idx) => (
                  <div key={idx} className="group/bio p-4 rounded-xl bg-white/5 border border-white/5 hover:border-primary/20 transition-all flex items-center gap-4">
              ...
              <div className="p-6 rounded-2xl border border-primary/20 bg-primary/5 space-y-4 relative overflow-hidden group/narrative">
  ...
  return (
    <div className="hydro-page-shell flex-1 relative w-full h-full flex flex-col font-body" style={{ position: 'absolute', inset: 0, overflowY: 'auto' }}>
      {/* Cinematic Athlete Header */}
      <div className="p-8 bg-gradient-to-b from-primary/15 to-transparent border-b border-white/5 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-end justify-between gap-12 flex-wrap">
          <div className="flex-1 min-w-[300px]">
            ...
            <h1 className="font-headline text-5xl font-black italic slanted uppercase text-on-surface text-glow mb-4">
              {swimmerName}
            </h1>
            ...
            <div className="flex items-center gap-10 flex-wrap">
              <div className="flex flex-col">
                ...
                <span className="font-headline text-2xl font-black italic slanted text-secondary gold-glow">#4</span>
              </div>
              ...
              <div className="h-10 w-[1px] bg-white/10" />
              <div className="flex flex-col">
                <span className="text-[9px] font-black text-on-surface-variant uppercase tracking-[0.3em] mb-1">Season</span>
                <span className="font-headline text-2xl font-black italic slanted text-on-surface uppercase">S4 Pro</span>
              </div>
            </div>
          </div>
