...
export const RaceResultScreen: React.FC<RaceResultScreenProps> = ({
  ...
  const finishResults = [
    { rank: 1, name: 'You', time: '00:51.23', medal: '🥇' },
        ...
        >
          {isWinner ? (
            <>
              ...
              <h1 className="text-4xl font-black text-yellow-300 mb-2">VICTORY!</h1>
              <p className="text-lg text-yellow-100">You've won the race with a new personal record!</p>
            </>
          ) : (
            <>
              <h1 className="text-4xl font-black text-white mb-2">Race Finished</h1>
              <p className="text-lg text-slate-300">You placed #{playerRank}</p>
            </>
          )}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-gradient-to-b from-slate-700/50 to-slate-800/50 rounded-lg p-8 border border-slate-600/30">
              <h2 className="text-2xl font-black text-white mb-6">Final Results</h2>
              ...
              <div className="flex items-end justify-center gap-4 mb-8 h-48">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="w-24 h-48 bg-gradient-to-t from-yellow-600/80 to-yellow-700/50 rounded-t-lg flex flex-col items-center justify-end p-3 border-2 border-yellow-500/50">
                    <div className="text-sm font-bold text-white text-center">You</div>
          ...
          <div className="space-y-6">
            {/* Rewards Box */}
            <div className="bg-gradient-to-br from-emerald-600/20 to-teal-600/20 rounded-lg p-6 border border-emerald-500/30">
            ...
            {/* Record Status */}
            <div className="bg-cyan-600/20 rounded-lg p-6 border border-cyan-500/30">
