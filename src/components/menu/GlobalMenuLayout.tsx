  ...
  return (
    <div className="app-race-theme w-full h-full min-h-dvh bg-background text-on-surface overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="flex-1 flex overflow-hidden gap-2 px-2 py-2 max-[900px]:px-1 max-[900px]:py-1">
          <div className="w-16 max-[900px]:w-12 shrink-0">
            <LeftNavigationRail currentScreen={currentScreen} onScreenChange={onScreenChange} />
          </div>

          <div className="flex-1 overflow-y-auto px-1 pb-2 max-[900px]:pb-2">{children}</div>
